...
<head>
	...
	<script type="text/javascript" src="<%=basePath%>js/deptList.js"></script>

</head>
<body>
	<div class="easyui-panel" style="padding:0px;width:1024px;height:460px;">
		<table id="depttree"></table>
	</div>
	
	<div id="menus" class="easyui-menu" style="width:120px;">
		<div onclick="append()" data-options="iconCls:'icon-add'">新增下级岗位</div>
		<div onclick="editIt()" data-options="iconCls:'icon-edit'">修改当前岗位</div>
		<div onclick="removeIt()" data-options="iconCls:'icon-remove'">删除当前岗位</div>
	</div>
